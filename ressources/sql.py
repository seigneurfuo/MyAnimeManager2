...
getFullSeriesList = """
SELECT Serie.serie_sort_id, Serie.serie_id, Serie.serie_title, Season.season_sort_id, Season.season_id, Season.season_title, Season.season_episodes, Season.season_release_year, Season.season_state, Season.season_view_count
FROM Season
